...
HELP_TEXT = (
    f"Usage: I respond to comments starting with `{BATSIGNAL}` (case insensitive).  \n"
...
BB_TEXT = (
    "The /r/malefashionadvide Basic Bastard Guides:  \n"
    "https://www.reddit.com/r/malefashionadvice/wiki/guides#wiki_basic_bastard"
)

ACRONYMS_TEXT = (
    "The /r/malefashionadvice acronyms guide:  \n"
    "https://www.reddit.com/r/malefashionadvice/wiki/glossary"
)

ITEMS_TEXT = (
    "The /r/malefashionadvice Your Favorite ___ for $___ mega threads:  \n"
